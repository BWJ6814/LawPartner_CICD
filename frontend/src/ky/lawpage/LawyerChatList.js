                        ...
                        {!roomId ? (
                            ...
                            <>
                                ...
                                {currentRoomStatus === 'ST01' && (
                                    <div style={{ background: '#fff7ed', padding: '10px 24px', textAlign: 'center', borderBottom: '1px solid #fed7aa', color: '#f97316', fontSize: 13, fontWeight: 700 }}>
                                        ⚠ 아직 수락하지 않은 상담입니다. 의뢰인의 사전 질문을 확인하세요.
                                    </div>
                                )}
