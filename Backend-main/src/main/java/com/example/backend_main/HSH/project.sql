...
/* 2-1 공통 코드 */
-- 1. 회원 권한 (USER_ROLE)
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('USER_ROLE', 'ROLE_USER', '일반 의뢰인');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('USER_ROLE', 'ROLE_LAWYER', '변호사');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('USER_ROLE', 'ROLE_ADMIN', '시스템 관리자');

-- 2. 회원 상태 (USER_STATUS)
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('USER_STATUS', 'S01', '정상 회원');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('USER_STATUS', 'S02', '휴면(장기 미접속)');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('USER_STATUS', 'S03', '이용 정지(차단)');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('USER_STATUS', 'S99', '탈퇴 회원');
...
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('CASE_STEP', 'ST01', '사건 접수/대기');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('CASE_STEP', 'ST02', '상담 진행 중');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('CASE_STEP', 'ST03', '소장 작성/검토');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('CASE_STEP', 'ST04', '소송 진행/재판');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('CASE_STEP', 'ST05', '판결/사건 종료');


-- 5. 결제 상태 (PAY_STATUS)
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('PAY_STATUS', 'P01', '결제 대기');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('PAY_STATUS', 'P02', '결제 완료(승인)');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('PAY_STATUS', 'P03', '결제 취소(사용자)');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('PAY_STATUS', 'P04', '환불 완료');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('PAY_STATUS', 'P99', '결제 오류/실패');


-- 6. 메시지 타입 (MSG_TYPE)
-- 오롯 1:1 실시간 채팅방을 위한 처리..
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('MSG_TYPE', 'TEXT', '일반 텍스트');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('MSG_TYPE', 'IMG',  '이미지 파일');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('MSG_TYPE', 'FILE', '일반 첨부파일(PDF 등)');
INSERT INTO TB_COM_CODE (GRP_CODE, DTL_CODE, CODE_NM) VALUES ('MSG_TYPE', 'SYS',  '시스템 알림 메시지');
...
UPDATE TB_LAWYER_INFO
SET LICENSE_NO = 11111
WHERE USER_NO = 22;
COMMIT;
/* 3-1. 변호사 전문 분야 (1:N 정규화)
   사용 안 함 처리
CREATE TABLE TB_LAWYER_SPECIALTY (
    -- SPECIALTY_ID는 자동 인덱스 처리..
    SPECIALTY_ID   NUMBER GENERATED BY DEFAULT AS IDENTITY,
    USER_NO        NUMBER NOT NULL,
    -- 민사, 형사, 이혼 등의 전문 분야 코드
    -- ex) L01 ,L02, L03.. (공통 테이블 사용)
    FIELD_CODE     VARCHAR2(20) NOT NULL,
    CONSTRAINT PK_LAWYER_SPECIALTY PRIMARY KEY (SPECIALTY_ID),
    -- 제약조건의 FK_SPEC_LAWYER이란 이름으로 테이블의 USER_ID 컬럼을 FK로 설정
    -- TB_LAWYER_INFO(변호사)테이블의 USER_ID가 부모!
    CONSTRAINT FK_SPEC_LAWYER FOREIGN KEY (USER_NO) REFERENCES TB_LAWYER_INFO(USER_NO)
);

select * from TB_LAWYER_SPECIALTY;
DROP TABLE TB_LAWYER_SPECIALTY;
*/
...
ALTER TABLE TB_NOTIFICATION
    ADD CONSTRAINT FK_NOTI_ROOM
        FOREIGN KEY (ROOM_ID) REFERENCES TB_CHAT_ROOM(ROOM_ID) ON DELETE SET NULL;
...
VALUES ('TRC-17-001', '111.222.33.44', '/api/main', 'Mozilla/5.0 Windows NT 10.0', 1, 200, 45, NULL, TO_DATE('2026-02-17 10:30:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-17-002', '111.222.33.45', '/api/login', 'Mozilla/5.0 Mac OS X', 2, 200, 120, NULL, TO_DATE('2026-02-17 11:15:00', 'YYYY-MM-DD HH24:MI:SS'));

-- 3. 5일 전 (2월 18일) - 3명 접속 (해킹 시도 에러 1건 포함!)
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-18-001', '192.168.1.10', '/api/admin/users', 'Mozilla/5.0 Windows NT 10.0', NULL, 403, 15, '권한 없음', TO_DATE('2026-02-18 09:20:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-18-002', '192.168.1.11', '/api/board', 'Mozilla/5.0 iPhone', 3, 200, 30, NULL, TO_DATE('2026-02-18 14:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-18-003', '192.168.1.12', '/api/main', 'Mozilla/5.0 Linux', 4, 200, 22, NULL, TO_DATE('2026-02-18 18:30:00', 'YYYY-MM-DD HH24:MI:SS'));

-- 4. 4일 전 (2월 19일) - 2명 접속
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-19-001', '10.0.0.5', '/api/lawyer', 'Mozilla/5.0 Windows NT 10.0', 5, 200, 50, NULL, TO_DATE('2026-02-19 10:10:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-19-002', '10.0.0.6', '/api/lawyer/detail', 'Mozilla/5.0 Mac OS X', 5, 200, 60, NULL, TO_DATE('2026-02-19 10:15:00', 'YYYY-MM-DD HH24:MI:SS'));

-- 5. 3일 전 (2월 20일) - 2명 접속 (서버 내부 500 에러 1건 포함!)
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-20-001', '172.16.0.1', '/api/login', 'PostmanRuntime/7.32.3', NULL, 500, 210, 'NullPointerException', TO_DATE('2026-02-20 02:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-20-002', '172.16.0.2', '/api/main', 'Mozilla/5.0 Android', 6, 200, 18, NULL, TO_DATE('2026-02-20 12:00:00', 'YYYY-MM-DD HH24:MI:SS'));

-- 6. 2일 전 (2월 21일) - 4명 접속 (주말 접속량 증가)
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-21-001', '8.8.8.8', '/api/chat', 'Mozilla/5.0 Windows NT 10.0', 7, 200, 100, NULL, TO_DATE('2026-02-21 09:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-21-002', '8.8.8.8', '/api/chat/send', 'Mozilla/5.0 Windows NT 10.0', 7, 200, 35, NULL, TO_DATE('2026-02-21 09:05:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-21-003', '8.8.4.4', '/api/main', 'Mozilla/5.0 iPhone', 8, 200, 25, NULL, TO_DATE('2026-02-21 15:30:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-21-004', '8.8.4.4', '/api/board', 'Mozilla/5.0 iPhone', 8, 200, 40, NULL, TO_DATE('2026-02-21 16:00:00', 'YYYY-MM-DD HH24:MI:SS'));

-- 7. 1일 전 (2월 22일) - 5명 접속
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-22-001', '211.111.22.33', '/api/main', 'Mozilla/5.0 Windows NT 10.0', 9, 200, 11, NULL, TO_DATE('2026-02-22 08:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-22-002', '211.111.22.34', '/api/lawyer', 'Mozilla/5.0 Android', 10, 200, 45, NULL, TO_DATE('2026-02-22 09:15:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-22-003', '211.111.22.35', '/api/consultation', 'Mozilla/5.0 Mac OS X', 11, 200, 32, NULL, TO_DATE('2026-02-22 13:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
VALUES ('TRC-22-004', '211.111.22.36', '/api/admin/users', 'curl/7.68.0', NULL, 403, 10, '접근 거부', TO_DATE('2026-02-22 15:45:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TB_ACCESS_LOG (TRACE_ID, REQ_IP, REQ_URI, USER_AGENT, USER_NO, STATUS_CODE, EXEC_TIME, ERROR_MSG, REG_DT)
